...
export default class UForm extends Component {
  ...
  //       dataSource: dataSource.filter(
  //         item =>
  //           (moment(item.createtime.substring(0, 10)) <= endtime &&
  //             moment(item.createtime.substring(0, 10)) >= startime) === true
  //       )
  //     });
  //   }
  // };
  ...
  MinusClick = () => {
    ...
    this.setState({
      dataSource: dataSource.filter(
        item => !isContains(selectedRowKeys, item.key)
      )
    });
  };
  //单个删除
