...
const data = [
  ...
  },
  {
    ...
    state: <Icon type="caret-up" style={{ color: "red" }} />,
    written:
      "必须坚持改革创新、将改革进行到底！只有在改革中推动社会发展、在创新中找到科学发展之路！",
    mail: "tobias.pedersen@example.com",
    time: "2020-01-11 13:03:59"
  },
  {
    key: "5",
  ...
  },
  {
    ...
    state: <Icon type="caret-up" style={{ color: "red" }} />,
    written:
      "对“为官不为”及时亮剑，集中曝光、整治“为官不为”“为官乱为”，使无为者让位、干事者有位。",
    mail: "samuel.leon@example.com",
    time: "2020-01-11 13:43:33"
  }
];
                ...
                <div className="timeline">
                  <Timeline>
                    <Timeline.Item color="green">
                      <div className="timeItem">创建项目 - 2020-01-11</div>
                      <div className="timeItem">搭建UI框架 - 2020-01-11</div>
                      <div className="timeItem">对接协议 - 2020-01-11</div>
                      <div className="timeItem">实现功能 - 2020-01-11</div>
                    </Timeline.Item>
                    <Timeline.Item color="red">
                      <div className="timeItem">通信调试 - 2020-01-11</div>
                      <div className="timeItem">功能测试 - 2020-01-11</div>
                      <div className="timeItem">错误调试 - 2020-01-11</div>
                    </Timeline.Item>
                    <Timeline.Item color="blue">
                      <div className="timeItem">界面优化 - 2020-01-11</div>
                      <div className="timeItem">性能优化 - 2020-01-11</div>
                      <div className="timeItem">发布版本 - 2020-01-11</div>
                    </Timeline.Item>
                  </Timeline>
                </div>
              </Card>
